# Overload Protection Middleware (Aşırı Yük Koruması)

## 1. Genel Bakış ve Tanım
Sistem kapasitesi aşıldığında kontrollü 503 dönerek çökmeyi engelleme.
...
Gelen İstek / Görev
        |
        v
[ overload_protection Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `overload_protection.go`
- **Test Senaryoları**: `overload_protection_test.go`
- **İngilizce Doküman**: `overload_protection.md`
