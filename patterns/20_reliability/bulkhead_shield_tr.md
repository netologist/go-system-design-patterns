# Bulkhead Failure Isolation Shield (Hata İzolasyon Kalkanı)

## 1. Genel Bakış ve Tanım
Harici bir servisteki çöküşün diğer servisleri etkilemesini engelleme.
...
Gelen İstek / Görev
        |
        v
[ bulkhead_shield Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `bulkhead_shield.go`
- **Test Senaryoları**: `bulkhead_shield_test.go`
- **İngilizce Doküman**: `bulkhead_shield.md`
