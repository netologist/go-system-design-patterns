# Exponential Backoff with Jitter (Rastgele Sapmalı Retry)

## 1. Genel Bakış ve Tanım
Geçici hatalarda üstel bekleme ve thundering herd önleyici tam jitter algoritması.
...
- **İmplementasyon**: `retry_backoff.go`
- **Test Senaryoları**: `retry_backoff_test.go`
- **İngilizce Doküman**: `retry_backoff.md`
