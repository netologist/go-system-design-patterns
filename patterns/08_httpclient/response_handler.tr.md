# Safe Response Body Handler (Güvenli Gövde Yönetimi)

## 1. Genel Bakış ve Tanım
Response body'yi sınırlandırarak okuma, io.Discard ile boşaltma ve bağlantıyı havuza döndürme.
...
Gelen İstek / Görev
        |
        v
[ response_handler Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `response_handler.go`
- **Test Senaryoları**: `response_handler_test.go`
- **İngilizce Doküman**: `response_handler.md`
