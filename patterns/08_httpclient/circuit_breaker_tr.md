...
Sürekli hata veren bağımlılığı geçici olarak bypass edip cascade failure'ı önleme.
...
Gelen İstek / Görev
        |
        v
[ circuit_breaker Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `circuit_breaker.go`
- **Test Senaryoları**: `circuit_breaker_test.go`
- **İngilizce Doküman**: `circuit_breaker.md`
