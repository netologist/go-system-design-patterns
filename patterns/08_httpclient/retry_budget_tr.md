# Retry Budget (Retry Bütçesi)

## 1. Genel Bakış ve Tanım
Aşırı retry fırtınalarının downstream servisi çökertmesini engelleyen oran sınırlayıcı.
...
- **İmplementasyon**: `retry_budget.go`
- **Test Senaryoları**: `retry_budget_test.go`
- **İngilizce Doküman**: `retry_budget.md`
