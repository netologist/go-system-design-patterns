# Pooled HTTP Client (Bağlantı Havuzlu İstemci)

## 1. Genel Bakış ve Tanım
TCP/TLS el sıkışma maliyetini azaltmak için connection reuse ve keep-alive yapılandırması.
...
- **İmplementasyon**: `pooled_client.go`
- **Test Senaryoları**: `pooled_client_test.go`
- **İngilizce Doküman**: `pooled_client.md`
