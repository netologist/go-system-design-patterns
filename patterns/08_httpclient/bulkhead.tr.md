# Downstream Bulkhead (İş Yükü İzolasyonu)

## 1. Genel Bakış ve Tanım
Bir harici servisteki yavaşlığın diğer servislere ayrılan kapasiteyi tüketmesini engelleme.
...
- **İmplementasyon**: `bulkhead.go`
- **Test Senaryoları**: `bulkhead_test.go`
- **İngilizce Doküman**: `bulkhead.md`
