# Consistent Response Envelope & DTOs (Standart Yanıt Zarfı)

## 1. Genel Bakış ve Tanım
Data, meta, error standart zarfı ve hassas alanların filtrelenmesi.
...
Gelen İstek / Görev
        |
        v
[ response_envelope Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `response_envelope.go`
- **Test Senaryoları**: `response_envelope_test.go`
- **İngilizce Doküman**: `response_envelope.md`
