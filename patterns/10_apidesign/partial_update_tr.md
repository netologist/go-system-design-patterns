# Partial Update Semantics - PATCH (Kısmi Güncelleme)

## 1. Genel Bakış ve Tanım
Gönderilmeyen alan ile null gönderilen alan ayrımını yapan pointer DTO yapısı.
...
Gelen İstek / Görev
        |
        v
[ partial_update Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `partial_update.go`
- **Test Senaryoları**: `partial_update_test.go`
- **İngilizce Doküman**: `partial_update.md`
