# ETag & Optimistic Concurrency (ETag Tabanlı Eşzamanlılık)

## 1. Genel Bakış ve Tanım
If-Match ve If-None-Match header'ları ile HTTP seviyesinde güncelleme kontrolü.
...
Gelen İstek / Görev
        |
        v
[ etag_concurrency Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `etag_concurrency.go`
- **Test Senaryoları**: `etag_concurrency_test.go`
- **İngilizce Doküman**: `etag_concurrency.md`
