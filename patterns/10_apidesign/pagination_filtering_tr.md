# Pagination, Filtering & Sorting (Sayfalama ve Filtreleme)

## 1. Genel Bakış ve Tanım
Güvenli ve sınırlandırılmış collection sorgu parametreleri yönetimi.
...
Gelen İstek / Görev
        |
        v
[ pagination_filtering Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `pagination_filtering.go`
- **Test Senaryoları**: `pagination_filtering_test.go`
- **İngilizce Doküman**: `pagination_filtering.md`
