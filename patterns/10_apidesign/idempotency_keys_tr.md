# Idempotency Keys (İdempotens Anahtarları)

## 1. Genel Bakış ve Tanım
Ağ kopması sonucu tekrar eden isteklerde aynı sonucun güvenle dönülmesi.
...
Gelen İstek / Görev
        |
        v
[ idempotency_keys Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `idempotency_keys.go`
- **Test Senaryoları**: `idempotency_keys_test.go`
- **İngilizce Doküman**: `idempotency_keys.md`
