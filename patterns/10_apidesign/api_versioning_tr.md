...
URL path (/v1/), X-API-Version ve Accept header versiyonlama stratejileri.
...
Gelen İstek / Görev
        |
        v
[ api_versioning Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `api_versioning.go`
- **Test Senaryoları**: `api_versioning_test.go`
- **İngilizce Doküman**: `api_versioning.md`
