# Layered Clean Architecture (Katmanlı Mimari)

## 1. Genel Bakış ve Tanım
Handler -> Service -> Repository sınırları ile bağımlılık yönünü koruma.
...
Gelen İstek / Görev
        |
        v
[ layered_architecture Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `layered_architecture.go`
- **Test Senaryoları**: `layered_architecture_test.go`
- **İngilizce Doküman**: `layered_architecture.md`
