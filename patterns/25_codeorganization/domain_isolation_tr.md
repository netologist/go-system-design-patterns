# Domain Isolation & Multi-Layer DTOs (Domain İzolasyonu)

## 1. Genel Bakış ve Tanım
Saf domain modelini SQL ve JSON etiketlerinden ayırarak koruma.
...
Gelen İstek / Görev
        |
        v
[ domain_isolation Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `domain_isolation.go`
- **Test Senaryoları**: `domain_isolation_test.go`
- **İngilizce Doküman**: `domain_isolation.md`
