# Signal Handling & Shutdown Deadline (Sinyal Yönetimi)

## 1. Genel Bakış ve Tanım
OS termination sinyallerini asenkron yakalama, timeout deadline ve acil çıkış yönetimi.
...
Gelen İstek / Görev
        |
        v
[ signal_handling Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `signal_handling.go`
- **Test Senaryoları**: `signal_handling_test.go`
- **İngilizce Doküman**: `signal_handling.md`
