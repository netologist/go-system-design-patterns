# Composition Root (Bileşen Kökü ve Temiz main)

## 1. Genel Bakış ve Tanım
Tüm bağımlılık ağacının tek bir bootstrap noktasında kurulup çalıştırılması.
...
Gelen İstek / Görev
        |
        v
[ composition_root Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `composition_root.go`
- **Test Senaryoları**: `composition_root_test.go`
- **İngilizce Doküman**: `composition_root.md`
