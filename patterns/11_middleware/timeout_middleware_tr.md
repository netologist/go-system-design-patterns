# Timeout Middleware (Zaman Aşımı Ara Yazılımı)

## 1. Genel Bakış ve Tanım
Uzayan handler işlemlerini context ile kesip 504 Gateway Timeout dönme.
...
Gelen İstek / Görev
        |
        v
[ timeout_middleware Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `timeout_middleware.go`
- **Test Senaryoları**: `timeout_middleware_test.go`
- **İngilizce Doküman**: `timeout_middleware.md`
