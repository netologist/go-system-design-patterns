# Middleware Chain (Ara Yazılım Zinciri)

## 1. Genel Bakış ve Tanım
Onion mimarisi ile ara yazılımların sıralı ve iç içe yürütülmesi.
...
Gelen İstek / Görev
        |
        v
[ middleware_chain Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `middleware_chain.go`
- **Test Senaryoları**: `middleware_chain_test.go`
- **İngilizce Doküman**: `middleware_chain.md`
