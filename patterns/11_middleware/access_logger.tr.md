# Access Logger Middleware (Erişim Günlüğü)

## 1. Genel Bakış ve Tanım
HTTP istek metodu, yol, durum kodu, yanıt boyutu ve süre kaydı.
...
- **İmplementasyon**: `access_logger.go`
- **Test Senaryoları**: `access_logger_test.go`
- **İngilizce Doküman**: `access_logger.md`
