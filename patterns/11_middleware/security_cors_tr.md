# Security Headers & CORS (Güvenlik Başlıkları ve CORS)

## 1. Genel Bakış ve Tanım
HSTS, X-Frame-Options, CSP ve preflight OPTIONS desteği.
...
- **İmplementasyon**: `security_cors.go`
- **Test Senaryoları**: `security_cors_test.go`
- **İngilizce Doküman**: `security_cors.md`
