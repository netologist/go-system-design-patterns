# Metrics & Tracing Middleware (Metrik ve İzleme)

## 1. Genel Bakış ve Tanım
Trafik, hata oranı ve gecikme histogramı toplayan ara yazılım.
...
Gelen İstek / Görev
        |
        v
[ metrics_tracing Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `metrics_tracing.go`
- **Test Senaryoları**: `metrics_tracing_test.go`
- **İngilizce Doküman**: `metrics_tracing.md`
