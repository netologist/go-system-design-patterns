# Secret Separation & Redaction (Gizli Veri Maskeleme)

## 1. Genel Bakış ve Tanım
Parola ve token'ların loglara sızmasını engelleyen Secret[T] ve URL sansürleme yapısı.
...
Gelen İstek / Görev
        |
        v
[ secret_sanitizer Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `secret_sanitizer.go`
- **Test Senaryoları**: `secret_sanitizer_test.go`
- **İngilizce Doküman**: `secret_sanitizer.md`
