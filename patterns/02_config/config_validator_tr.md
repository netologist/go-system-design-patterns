# Config Validation (Konfigürasyon Doğrulama)

## 1. Genel Bakış ve Tanım
Port, URL şemaları, timeout ve enum kurallarının doğrulanması.
...
Gelen İstek / Görev
        |
        v
[ config_validator Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `config_validator.go`
- **Test Senaryoları**: `config_validator_test.go`
- **İngilizce Doküman**: `config_validator.md`
