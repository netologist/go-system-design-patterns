# Immutable Runtime Config (Değişmez Konfigürasyon)

## 1. Genel Bakış ve Tanım
Başlangıç sonrası runtime'da konfigürasyonun değiştirilmesini engelleyen defensive copy yapısı.
...
Gelen İstek / Görev
        |
        v
[ immutable_config Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `immutable_config.go`
- **Test Senaryoları**: `immutable_config_test.go`
- **İngilizce Doküman**: `immutable_config.md`
