# Typed Configuration & Fail-Fast (Tipli Konfigürasyon)

## 1. Genel Bakış ve Tanım
Ortam değişkenlerini startup'ta tipli struct'a çevirip hataları ilk saniyede yakalama.
...
- **İmplementasyon**: `typed_config.go`
- **Test Senaryoları**: `typed_config_test.go`
- **İngilizce Doküman**: `typed_config.md`
