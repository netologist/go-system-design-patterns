# Keyset / Cursor Pagination (İmleç Tabanlı Sayfalama)

## 1. Genel Bakış ve Tanım
Büyük tablolarda OFFSET yerine indeksli son görülen kayıt üzerinden hızlı sayfalama.
...
Gelen İstek / Görev
        |
        v
[ keyset_pagination Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `keyset_pagination.go`
- **Test Senaryoları**: `keyset_pagination_test.go`
- **İngilizce Doküman**: `keyset_pagination.md`
