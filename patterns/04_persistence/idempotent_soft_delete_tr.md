# Idempotent Write & Soft Delete (Güvenli Yazma ve Geçici Silme)

## 1. Genel Bakış ve Tanım
Tekrarlanan yazmalarda yan etki üretmeme ve fiziksel silme yerine deleted_at kullanımı.
...
Gelen İstek / Görev
        |
        v
[ idempotent_soft_delete Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `idempotent_soft_delete.go`
- **Test Senaryoları**: `idempotent_soft_delete_test.go`
- **İngilizce Doküman**: `idempotent_soft_delete.md`
