# Unit of Work & Transaction Boundary (İş Birimi)

## 1. Genel Bakış ve Tanım
Çoklu repository işlemlerini tek transaction'da commit/rollback ile yönetme.
...
- **İmplementasyon**: `unit_of_work.go`
- **Test Senaryoları**: `unit_of_work_test.go`
- **İngilizce Doküman**: `unit_of_work.md`
