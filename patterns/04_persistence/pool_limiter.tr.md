# Connection Pool Limiting (Bağlantı Havuzu Sınırı)

## 1. Genel Bakış ve Tanım
Veritabanı bağlantı havuzuna üst limit koyup havuz tükenmesini engelleme.
...
- **İmplementasyon**: `pool_limiter.go`
- **Test Senaryoları**: `pool_limiter_test.go`
- **İngilizce Doküman**: `pool_limiter.md`
