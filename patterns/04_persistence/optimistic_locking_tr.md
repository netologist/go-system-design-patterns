...
Version alanı kontrolü ile eşzamanlı güncellemelerde veri ezilmesini önleme.
...
Gelen İstek / Görev
        |
        v
[ optimistic_locking Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `optimistic_locking.go`
- **Test Senaryoları**: `optimistic_locking_test.go`
- **İngilizce Doküman**: `optimistic_locking.md`
