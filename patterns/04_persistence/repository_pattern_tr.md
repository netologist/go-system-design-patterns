# Repository Pattern & Context Queries (Depo Deseni)

## 1. Genel Bakış ve Tanım
Veri erişim detaylarını soyutlayıp tüm işlemlere context iptal desteği sağlama.
...
Gelen İstek / Görev
        |
        v
[ repository_pattern Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `repository_pattern.go`
- **Test Senaryoları**: `repository_pattern_test.go`
- **İngilizce Doküman**: `repository_pattern.md`
