# Bounded Memory Buffer Pool (Sınırlı Bellek Havuzu)

## 1. Genel Bakış ve Tanım
sync.Pool ile bellek tekrar kullanımı ve aşırı büyük buffer'ların tahliyesi.
...
- **İmplementasyon**: `buffer_pool.go`
- **Test Senaryoları**: `buffer_pool_test.go`
- **İngilizce Doküman**: `buffer_pool.md`
