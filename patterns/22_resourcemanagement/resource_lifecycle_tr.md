# Resource Ownership & Lifecycle Tracker (Kaynak Yaşam Döngüsü)

## 1. Genel Bakış ve Tanım
Açılan kaynakların sahipliği, üst sınırı ve timeout ile temizlenmesi.
...
Gelen İstek / Görev
        |
        v
[ resource_lifecycle Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `resource_lifecycle.go`
- **Test Senaryoları**: `resource_lifecycle_test.go`
- **İngilizce Doküman**: `resource_lifecycle.md`
