# Typed Context Values (Güvenli Context Değerleri)

## 1. Genel Bakış ve Tanım
Paketler arası çakışmayı önleyen unexported özel context anahtarları disiplini.
...
Gelen İstek / Görev
        |
        v
[ typed_context_values Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `typed_context_values.go`
- **Test Senaryoları**: `typed_context_values_test.go`
- **İngilizce Doküman**: `typed_context_values.md`
