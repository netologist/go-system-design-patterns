# Context Propagation (Context Taşıma)

## 1. Genel Bakış ve Tanım
HTTP handler'dan veritabanına kadar iptal ve süre bilgisini katmanlar arası taşıma.
...
Gelen İstek / Görev
        |
        v
[ context_propagation Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `context_propagation.go`
- **Test Senaryoları**: `context_propagation_test.go`
- **İngilizce Doküman**: `context_propagation.md`
