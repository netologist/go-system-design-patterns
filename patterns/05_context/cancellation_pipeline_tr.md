# Context Cancellation Pipeline (İptal Güvenli Pipeline)

## 1. Genel Bakış ve Tanım
İptal sinyali geldiğinde tüm çalışan worker goroutine'leri anında sonlandırma.
...
Gelen İstek / Görev
        |
        v
[ cancellation_pipeline Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `cancellation_pipeline.go`
- **Test Senaryoları**: `cancellation_pipeline_test.go`
- **İngilizce Doküman**: `cancellation_pipeline.md`
