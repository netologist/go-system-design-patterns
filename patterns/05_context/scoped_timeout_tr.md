# Scoped Timeout & Budget Propagation (Süre Sınırı Yönetimi)

## 1. Genel Bakış ve Tanım
Alt işlere verilen timeout'un üst istek bütçesini aşmamasını sağlama.
...
Gelen İstek / Görev
        |
        v
[ scoped_timeout Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `scoped_timeout.go`
- **Test Senaryoları**: `scoped_timeout_test.go`
- **İngilizce Doküman**: `scoped_timeout.md`
