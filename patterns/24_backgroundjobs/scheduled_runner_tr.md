# Scheduled Periodic Runner (Zamanlanmış İş Çalıştırıcı)

## 1. Genel Bakış ve Tanım
Periyodik arka plan işlerini context iptal desteği ile çalıştırma.
...
Gelen İstek / Görev
        |
        v
[ scheduled_runner Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `scheduled_runner.go`
- **Test Senaryoları**: `scheduled_runner_test.go`
- **İngilizce Doküman**: `scheduled_runner.md`
