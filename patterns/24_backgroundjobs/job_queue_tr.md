# Visibility Timeout Job Queue (Görünürlük Süreli İş Kuyruğu)

## 1. Genel Bakış ve Tanım
İş çekildiğinde belirli süre gizlenen ve worker çökerse geri çıkan kuyruk.
...
- **İmplementasyon**: `job_queue.go`
- **Test Senaryoları**: `job_queue_test.go`
- **İngilizce Doküman**: `job_queue.md`
