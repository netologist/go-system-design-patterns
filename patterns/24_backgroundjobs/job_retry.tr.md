# Job Retry & Poison Quarantine (İş Yeniden Deneme ve Karantina)

## 1. Genel Bakış ve Tanım
Başarısız işleri üstel bekleme ile deneme ve zehirli işleri karantinaya alma.
...
- **İmplementasyon**: `job_retry.go`
- **Test Senaryoları**: `job_retry_test.go`
- **İngilizce Doküman**: `job_retry.md`
