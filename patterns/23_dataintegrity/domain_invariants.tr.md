# Domain Invariants & Audit Trail (Değişmezler ve Denetim İzi)

## 1. Genel Bakış ve Tanım
İş kurallarını koruma ve her hareket için silinemez denetim günlüğü tutma.
...
Gelen İstek / Görev
        |
        v
[ domain_invariants Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `domain_invariants.go`
- **Test Senaryoları**: `domain_invariants_test.go`
- **İngilizce Doküman**: `domain_invariants.md`
