# Keyed Mutex / Pessimistic Locking (Satır Bazlı Kilit)

## 1. Genel Bakış ve Tanım
Kaynak ID bazında satır seviyesinde dışlayıcı kilit yönetimi.
...
Gelen İstek / Görev
        |
        v
[ pessimistic_lock Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `pessimistic_lock.go`
- **Test Senaryoları**: `pessimistic_lock_test.go`
- **İngilizce Doküman**: `pessimistic_lock.md`
