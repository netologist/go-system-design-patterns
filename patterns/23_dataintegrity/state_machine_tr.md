# Guarded State Machine (Korumalı Durum Makinesi)

## 1. Genel Bakış ve Tanım
Geçersiz durum geçişlerini engelleyen kurallı sonlu durum makinesi.
...
- **İmplementasyon**: `state_machine.go`
- **Test Senaryoları**: `state_machine_test.go`
- **İngilizce Doküman**: `state_machine.md`
