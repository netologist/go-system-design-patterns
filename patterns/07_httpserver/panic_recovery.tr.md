# Panic Recovery Middleware (Panik Kurtarma)

## 1. Genel Bakış ve Tanım
Handler içerisindeki panikleri yakalayıp process'i düşürmeden 500 JSON dönme.
...
Gelen İstek / Görev
        |
        v
[ panic_recovery Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `panic_recovery.go`
- **Test Senaryoları**: `panic_recovery_test.go`
- **İngilizce Doküman**: `panic_recovery.md`
