# Hardened HTTP Server (Sertleştirilmiş HTTP Sunucusu)

## 1. Genel Bakış ve Tanım
Slowloris saldırılarına karşı ReadHeaderTimeout, Read/Write/Idle timeout yapılandırması.
...
Gelen İstek / Görev
        |
        v
[ hardened_server Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `hardened_server.go`
- **Test Senaryoları**: `hardened_server_test.go`
- **İngilizce Doküman**: `hardened_server.md`
