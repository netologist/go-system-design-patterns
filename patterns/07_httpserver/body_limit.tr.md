# Request Body Limit & Content-Type (Gövde Sınırı)

## 1. Genel Bakış ve Tanım
http.MaxBytesReader ile bellek tüketimini sınırlama ve media type doğrulama.
...
- **İmplementasyon**: `body_limit.go`
- **Test Senaryoları**: `body_limit_test.go`
- **İngilizce Doküman**: `body_limit.md`
