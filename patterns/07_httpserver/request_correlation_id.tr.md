# Request & Correlation ID (İstek Takip Kimliği)

## 1. Genel Bakış ve Tanım
Dağıtık sistemlerde X-Request-ID ve X-Correlation-ID üretme ve taşıma.
...
Gelen İstek / Görev
        |
        v
[ request_correlation_id Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `request_correlation_id.go`
- **Test Senaryoları**: `request_correlation_id_test.go`
- **İngilizce Doküman**: `request_correlation_id.md`
