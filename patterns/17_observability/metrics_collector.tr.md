# Metrics Collector (Metrik Toplayıcı)

## 1. Genel Bakış ve Tanım
Sayaçlar (Counter), göstergeler (Gauge) ve p50/p95/p99 gecikme histogramları.
...
Gelen İstek / Görev
        |
        v
[ metrics_collector Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `metrics_collector.go`
- **Test Senaryoları**: `metrics_collector_test.go`
- **İngilizce Doküman**: `metrics_collector.md`
