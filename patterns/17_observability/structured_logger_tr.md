# Structured JSON Logger (Yapılandırılmış JSON Loglama)

## 1. Genel Bakış ve Tanım
Log seviyeleri, bağlam kimlikleri, maskeleme ve örnekleme desteği.
...
Gelen İstek / Görev
        |
        v
[ structured_logger Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `structured_logger.go`
- **Test Senaryoları**: `structured_logger_test.go`
- **İngilizce Doküman**: `structured_logger.md`
