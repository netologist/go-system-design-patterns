# Distributed Tracer (Dağıtık İzleme)

## 1. Genel Bakış ve Tanım
TraceID, SpanID, ParentID ve span etiketleri ile uçtan uca istek takibi.
...
- **İmplementasyon**: `tracer.go`
- **Test Senaryoları**: `tracer_test.go`
- **İngilizce Doküman**: `tracer.md`
