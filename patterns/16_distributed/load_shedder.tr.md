# Adaptive Load Shedding (Uyarlanabilir Yük Atma)

## 1. Genel Bakış ve Tanım
Aşırı yük altında sistemin tamamen çökmesi yerine düşük öncelikli işleri erken reddetme.
...
- **İmplementasyon**: `load_shedder.go`
- **Test Senaryoları**: `load_shedder_test.go`
- **İngilizce Doküman**: `load_shedder.md`
