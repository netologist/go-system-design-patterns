# Lease-Based Leader Election (Lider Seçimi)

## 1. Genel Bakış ve Tanım
Zamanlanmış işleri tek bir aktif instance'ın yürütmesini sağlama.
...
Gelen İstek / Görev
        |
        v
[ leader_election Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `leader_election.go`
- **Test Senaryoları**: `leader_election_test.go`
- **İngilizce Doküman**: `leader_election.md`
