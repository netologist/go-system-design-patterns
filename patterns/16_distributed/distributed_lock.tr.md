# Distributed Lock with Fencing (Dağıtık Kilit)

## 1. Genel Bakış ve Tanım
TTL kira süresi ve monoton artan fencing token ile kilit güvenliği.
...
Gelen İstek / Görev
        |
        v
[ distributed_lock Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `distributed_lock.go`
- **Test Senaryoları**: `distributed_lock_test.go`
- **İngilizce Doküman**: `distributed_lock.md`
