# Saga Orchestrator (Saga Orkestratörü)

## 1. Genel Bakış ve Tanım
Dağıtık transaction yerine ileri adımlar ve başarısızlıkta geri telafi (compensation) adımları.
...
Gelen İstek / Görev
        |
        v
[ saga_orchestrator Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `saga_orchestrator.go`
- **Test Senaryoları**: `saga_orchestrator_test.go`
- **İngilizce Doküman**: `saga_orchestrator.md`
