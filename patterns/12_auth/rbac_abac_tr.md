# RBAC & ABAC (Rol ve Nitelik Tabanlı Erişim)

## 1. Genel Bakış ve Tanım
Rol yetki matrisi ile dinamik bağlam niteliklerinin birlikte değerlendirilmesi.
...
- **İmplementasyon**: `rbac_abac.go`
- **Test Senaryoları**: `rbac_abac_test.go`
- **İngilizce Doküman**: `rbac_abac.md`
