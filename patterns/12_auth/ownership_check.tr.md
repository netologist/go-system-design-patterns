# Resource Ownership & IDOR Defense (Kaynak Sahipliği)

## 1. Genel Bakış ve Tanım
Kullanıcının yalnızca kendi kaynaklarına erişebilmesini güvenceye alma.
...
Gelen İstek / Görev
        |
        v
[ ownership_check Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `ownership_check.go`
- **Test Senaryoları**: `ownership_check_test.go`
- **İngilizce Doküman**: `ownership_check.md`
