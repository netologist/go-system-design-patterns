# Refresh Token Rotation (Yenileme Tokenı Döndürme)

## 1. Genel Bakış ve Tanım
Token çalınmasını ve tekrar kullanımını tespit edip tüm oturumu iptal etme.
...
Gelen İstek / Görev
        |
        v
[ token_rotation Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `token_rotation.go`
- **Test Senaryoları**: `token_rotation_test.go`
- **İngilizce Doküman**: `token_rotation.md`
