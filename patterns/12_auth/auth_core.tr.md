# Authentication vs Authorization & Fail-Closed (Kimlik ve Yetki)

## 1. Genel Bakış ve Tanım
Kimlik doğrulama ile yetki ayrımı ve varsayılan olarak reddetme (fail-closed) kuralı.
...
- **İmplementasyon**: `auth_core.go`
- **Test Senaryoları**: `auth_core_test.go`
- **İngilizce Doküman**: `auth_core.md`
