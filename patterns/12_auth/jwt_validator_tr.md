# JWT Validation & Expiration (JWT Doğrulama)

## 1. Genel Bakış ve Tanım
HMAC-SHA256 imza kontrolü, süre dolumu ve claims doğrulama.
...
- **İmplementasyon**: `jwt_validator.go`
- **Test Senaryoları**: `jwt_validator_test.go`
- **İngilizce Doküman**: `jwt_validator.md`
