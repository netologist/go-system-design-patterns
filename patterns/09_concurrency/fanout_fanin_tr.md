# Fan-Out / Fan-In (Dağıt - Topla Deseni)

## 1. Genel Bakış ve Tanım
İşleri paralel worker kanallarına dağıtıp sonuçları tek kanalda birleştirme.
...
- **İmplementasyon**: `fanout_fanin.go`
- **Test Senaryoları**: `fanout_fanin_test.go`
- **İngilizce Doküman**: `fanout_fanin.md`
