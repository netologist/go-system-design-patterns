# Channel Ownership & Mutex Discipline (Kanal Sahipliği)

## 1. Genel Bakış ve Tanım
Kanalı açan ve kapatanın üretici olması kuralı ve küçük lock kapsamı disiplini.
...
Gelen İstek / Görev
        |
        v
[ channel_ownership Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `channel_ownership.go`
- **Test Senaryoları**: `channel_ownership_test.go`
- **İngilizce Doküman**: `channel_ownership.md`
