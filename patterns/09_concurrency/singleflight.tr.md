# Singleflight (Tek Uçuş Deseni)

## 1. Genel Bakış ve Tanım
Aynı anahtar için gelen eşzamanlı isteklerde ağır işlemi 1 kez çalıştırıp sonucu paylaşma.
...
- **İmplementasyon**: `singleflight.go`
- **Test Senaryoları**: `singleflight_test.go`
- **İngilizce Doküman**: `singleflight.md`
