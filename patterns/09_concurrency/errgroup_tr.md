# ErrGroup with Context Cancellation (Hata Gruplama)

## 1. Genel Bakış ve Tanım
Eşzamanlı işlerde ilk hata oluştuğunda diğer tüm kardeş işleri iptal etme.
...
- **İmplementasyon**: `errgroup.go`
- **Test Senaryoları**: `errgroup_test.go`
- **İngilizce Doküman**: `errgroup.md`
