# Counting Weighted Semaphore (Ağırlıklı Semafor)

## 1. Genel Bakış ve Tanım
Aynı anda çalışan işlem sayısını sınırlayan kapasite mekanizması.
...
- **İmplementasyon**: `semaphore.go`
- **Test Senaryoları**: `semaphore_test.go`
- **İngilizce Doküman**: `semaphore.md`
