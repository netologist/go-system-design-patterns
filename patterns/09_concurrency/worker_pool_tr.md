# Bounded Worker Pool (Sınırlı İşçi Havuzu)

## 1. Genel Bakış ve Tanım
Kontrolsüz goroutine patlamasını engelleyen sabit kapasiteli işçi havuzu.
...
- **İmplementasyon**: `worker_pool.go`
- **Test Senaryoları**: `worker_pool_test.go`
- **İngilizce Doküman**: `worker_pool.md`
