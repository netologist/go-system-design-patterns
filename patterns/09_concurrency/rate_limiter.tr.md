# Token Bucket Rate Limiter (Jeton Kovalı Hız Sınırlayıcı)

## 1. Genel Bakış ve Tanım
Birim zamanda izin verilen işlem sayısını ve burst kapasitesini kontrol etme.
...
- **İmplementasyon**: `rate_limiter.go`
- **Test Senaryoları**: `rate_limiter_test.go`
- **İngilizce Doküman**: `rate_limiter.md`
