# Backpressure & Bounded Queue (Geri Basınç Kuyruğu)

## 1. Genel Bakış ve Tanım
Kuyruk dolduğunda üreticiyi yavaşlatma, reddetme veya en eskiyi atma stratejileri.
...
Gelen İstek / Görev
        |
        v
[ backpressure_queue Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `backpressure_queue.go`
- **Test Senaryoları**: `backpressure_queue_test.go`
- **İngilizce Doküman**: `backpressure_queue.md`
