# Read/Write Separation & Replica Lag (Okuma/Yazma Ayrımı)

## 1. Genel Bakış ve Tanım
Yazmaları ana sunucuya, okumaları replikaya yönlendirme ve son yazma oturumu koruması.
...
Gelen İstek / Görev
        |
        v
[ read_write_splitter Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `read_write_splitter.go`
- **Test Senaryoları**: `read_write_splitter_test.go`
- **İngilizce Doküman**: `read_write_splitter.md`
