# Batch Loader - N+1 Query Prevention (Toplu Yükleyici)

## 1. Genel Bakış ve Tanım
Ayrı ayrı gelen ID sorgularını tek bir toplu sorguda birleştirme.
...
- **İmplementasyon**: `batch_loader.go`
- **Test Senaryoları**: `batch_loader_test.go`
- **İngilizce Doküman**: `batch_loader.md`
