# Transaction Boundary (Transaction Sınırı)

## 1. Genel Bakış ve Tanım
Transaction içinde asla ağ çağrısı yapmama ve kilit süresini minimumda tutma.
...
Gelen İstek / Görev
        |
        v
[ transaction_boundary Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `transaction_boundary.go`
- **Test Senaryoları**: `transaction_boundary_test.go`
- **İngilizce Doküman**: `transaction_boundary.md`
