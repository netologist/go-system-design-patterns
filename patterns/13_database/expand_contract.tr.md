# Expand/Contract Schema Migration (Genişlet/Daralt Deseni)

## 1. Genel Bakış ve Tanım
Sıfır kesinti ile veritabanı şema evrimi ve geriye uyumlu geçiş.
...
Gelen İstek / Görev
        |
        v
[ expand_contract Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `expand_contract.go`
- **Test Senaryoları**: `expand_contract_test.go`
- **İngilizce Doküman**: `expand_contract.md`
