# TTL & Cache Invalidation (Süre ve Önbellek Temizleme)

## 1. Genel Bakış ve Tanım
Prefix ve etiket bazlı önbellek temizleme mekanizmaları.
...
Gelen İstek / Görev
        |
        v
[ ttl_invalidation Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `ttl_invalidation.go`
- **Test Senaryoları**: `ttl_invalidation_test.go`
- **İngilizce Doküman**: `ttl_invalidation.md`
