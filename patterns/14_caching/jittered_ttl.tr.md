# Jittered TTL (Rastgele Sapmalı Önbellek Süresi)

## 1. Genel Bakış ve Tanım
Aynı anda yüklenen binlerce kaydın aynı saniyede expire olmasını engelleme.
...
- **İmplementasyon**: `jittered_ttl.go`
- **Test Senaryoları**: `jittered_ttl_test.go`
- **İngilizce Doküman**: `jittered_ttl.md`
