# Cache Stampede Prevention (Önbellek İzdihamı Koruması)

## 1. Genel Bakış ve Tanım
Önbellek süresi bittiğinde DB'ye aynı anda binlerce sorgu gitmesini Singleflight ile engelleme.
...
Gelen İstek / Görev
        |
        v
[ stampede_prevention Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `stampede_prevention.go`
- **Test Senaryoları**: `stampede_prevention_test.go`
- **İngilizce Doküman**: `stampede_prevention.md`
