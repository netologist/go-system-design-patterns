# Cache-Aside Pattern (Önbelleğe Alma Deseni)

## 1. Genel Bakış ve Tanım
Önce cache kontrolü, miss durumunda DB'den okuyup cache'e yazma ve mutasyonda silme.
...
- **İmplementasyon**: `cache_aside.go`
- **Test Senaryoları**: `cache_aside_test.go`
- **İngilizce Doküman**: `cache_aside.md`
