# Bounded LRU Cache (Sınırlı LRU Önbellek)

## 1. Genel Bakış ve Tanım
Bellek patlamasını engelleyen en az kullanılanı tahliye eden önbellek.
...
- **İmplementasyon**: `bounded_lru.go`
- **Test Senaryoları**: `bounded_lru_test.go`
- **İngilizce Doküman**: `bounded_lru.md`
