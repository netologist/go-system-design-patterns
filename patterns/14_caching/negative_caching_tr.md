# Negative Caching (Negatif Önbellekleme)

## 1. Genel Bakış ve Tanım
Bulunamayan kaynakları kısa süreli önbelleğe alarak DB'yi boş sorgulardan koruma.
...
Gelen İstek / Görev
        |
        v
[ negative_caching Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `negative_caching.go`
- **Test Senaryoları**: `negative_caching_test.go`
- **İngilizce Doküman**: `negative_caching.md`
