# Central Error Mapping (Merkezi Hata Eşleme)

## 1. Genel Bakış ve Tanım
Domain hatalarını HTTP durum kodlarına eşleyip iç detayların sızmasını önleme.
...
- **İmplementasyon**: `error_mapping.go`
- **Test Senaryoları**: `error_mapping_test.go`
- **İngilizce Doküman**: `error_mapping.md`
