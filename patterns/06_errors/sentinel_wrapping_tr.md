# Sentinel Errors & %w Wrapping (Sentinel Hatalar)

## 1. Genel Bakış ve Tanım
Önceden tanımlı hataları %w ile sarmalayıp errors.Is ile güvenle tanıma.
...
Gelen İstek / Görev
        |
        v
[ sentinel_wrapping Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `sentinel_wrapping.go`
- **Test Senaryoları**: `sentinel_wrapping_test.go`
- **İngilizce Doküman**: `sentinel_wrapping.md`
