...
Standart JSON problem detayları formatında API hata yanıtı üretme.
...
Gelen İstek / Görev
        |
        v
[ structured_response Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `structured_response.go`
- **Test Senaryoları**: `structured_response_test.go`
- **İngilizce Doküman**: `structured_response.md`
