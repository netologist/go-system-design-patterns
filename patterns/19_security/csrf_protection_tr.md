# CSRF Protection (Siteler Arası İstek Sahteciliği)

## 1. Genel Bakış ve Tanım
HMAC imzalı oturum bağımlı double-submit token doğrulama.
...
Gelen İstek / Görev
        |
        v
[ csrf_protection Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `csrf_protection.go`
- **Test Senaryoları**: `csrf_protection_test.go`
- **İngilizce Doküman**: `csrf_protection.md`
