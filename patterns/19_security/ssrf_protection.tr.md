# SSRF Protection (Sunucu Taraflı İstek Sahteciliği Savunması)

## 1. Genel Bakış ve Tanım
İç ağ IP'lerine ve bulut metadata (169.254.169.254) adreslerine erişimi engelleme.
...
Gelen İstek / Görev
        |
        v
[ ssrf_protection Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `ssrf_protection.go`
- **Test Senaryoları**: `ssrf_protection_test.go`
- **İngilizce Doküman**: `ssrf_protection.md`
