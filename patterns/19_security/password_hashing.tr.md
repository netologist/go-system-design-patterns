# Password Hashing & PBKDF2 (Tuzlu Parola Hashleme)

## 1. Genel Bakış ve Tanım
Kriptografik tuz ve sabit zamanlı karşılaştırma ile parola güvenliği.
...
Gelen İstek / Görev
        |
        v
[ password_hashing Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `password_hashing.go`
- **Test Senaryoları**: `password_hashing_test.go`
- **İngilizce Doküman**: `password_hashing.md`
