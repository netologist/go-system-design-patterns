# Input Validation & XSS Defense (Girdi Doğrulama)

## 1. Genel Bakış ve Tanım
Girdileri sınırda doğrulama ve HTML/XSS etiketlerini zararsız hale getirme.
...
Gelen İstek / Görev
        |
        v
[ input_validation Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `input_validation.go`
- **Test Senaryoları**: `input_validation_test.go`
- **İngilizce Doküman**: `input_validation.md`
