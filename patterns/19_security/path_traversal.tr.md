# Path Traversal Defense (Dizin Atlama Savunması)

## 1. Genel Bakış ve Tanım
Dosya yollarını temizleyerek ../ ve null byte saldırılarını engelleme.
...
Gelen İstek / Görev
        |
        v
[ path_traversal Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `path_traversal.go`
- **Test Senaryoları**: `path_traversal_test.go`
- **İngilizce Doküman**: `path_traversal.md`
