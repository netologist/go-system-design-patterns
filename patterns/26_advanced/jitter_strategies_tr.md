# Advanced Jitter Strategies: Full, Equal, Decorrelated (Gelişmiş Jitter)

## 1. Genel Bakış ve Tanım
Yeniden denemelerde thundering herd dalgalarını yok eden rastgeleleştirme algoritmaları.
...
Gelen İstek / Görev
        |
        v
[ jitter_strategies Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `jitter_strategies.go`
- **Test Senaryoları**: `jitter_strategies_test.go`
- **İngilizce Doküman**: `jitter_strategies.md`
