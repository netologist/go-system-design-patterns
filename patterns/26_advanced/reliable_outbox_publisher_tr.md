# Transactional Outbox with Reliable Publisher (Güvenilir Outbox)

## 1. Genel Bakış ve Tanım
Dual-write problemini çözen arka plan relay yayınlayıcı deseni.
...
Gelen İstek / Görev
        |
        v
[ reliable_outbox_publisher Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `reliable_outbox_publisher.go`
- **Test Senaryoları**: `reliable_outbox_publisher_test.go`
- **İngilizce Doküman**: `reliable_outbox_publisher.md`
