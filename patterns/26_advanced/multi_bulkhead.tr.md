# Multi-Workload Bulkhead (Çoklu İş Yükü İzolasyonu)

## 1. Genel Bakış ve Tanım
Payment, Email ve KYC iş yüklerine ayrı kuyruk ve worker havuzu tahsis etme.
...
Gelen İstek / Görev
        |
        v
[ multi_bulkhead Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `multi_bulkhead.go`
- **Test Senaryoları**: `multi_bulkhead_test.go`
- **İngilizce Doküman**: `multi_bulkhead.md`
