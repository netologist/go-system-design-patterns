# Latency EMA Adaptive Load Shedder (Gecikme Ortalamalı Yük Atma)

## 1. Genel Bakış ve Tanım
Gecikme süresi hedeflenen SLA'yı aştığında yükü otomatik atarak sistemi koruma.
...
Gelen İstek / Görev
        |
        v
[ adaptive_shedder Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `adaptive_shedder.go`
- **Test Senaryoları**: `adaptive_shedder_test.go`
- **İngilizce Doküman**: `adaptive_shedder.md`
