# End-to-End Idempotent Payment Pipeline (Uçtan Uca İdempotent Ödeme)

## 1. Genel Bakış ve Tanım
İdempotens anahtarı, durum makinesi ve DB dışı ödeme çağrısı birleşimi.
...
Gelen İstek / Görev
        |
        v
[ idempotent_payment_pipeline Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `idempotent_payment_pipeline.go`
- **Test Senaryoları**: `idempotent_payment_pipeline_test.go`
- **İngilizce Doküman**: `idempotent_payment_pipeline.md`
