# Property-Based Invariant Testing (Özellik ve Değişmez Testi)

## 1. Genel Bakış ve Tanım
Rastgele üretilen çok sayıda operasyon sonrası sistem kurallarının korunduğunu kanıtlama.
...
Gelen İstek / Görev
        |
        v
[ property_invariant Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `property_invariant.go`
- **Test Senaryoları**: `property_invariant_test.go`
- **İngilizce Doküman**: `property_invariant.md`
