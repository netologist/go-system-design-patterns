# Table-Driven Tests (Tablo Güdümlü Testler)

## 1. Genel Bakış ve Tanım
Girdi ve beklenen çıktıları veri tablosu olarak tanımlayıp alt testlerle çalıştırma.
...
- **İmplementasyon**: `table_driven.go`
- **Test Senaryoları**: `table_driven_test.go`
- **İngilizce Doküman**: `table_driven.md`
