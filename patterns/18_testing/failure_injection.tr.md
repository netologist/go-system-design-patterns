# Failure Injection & Chaos Testing (Hata Enjeksiyonu)

## 1. Genel Bakış ve Tanım
Dayanıklılık mekanizmalarını test etmek için yapay gecikme ve hata üretme.
...
Gelen İstek / Görev
        |
        v
[ failure_injection Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `failure_injection.go`
- **Test Senaryoları**: `failure_injection_test.go`
- **İngilizce Doküman**: `failure_injection.md`
