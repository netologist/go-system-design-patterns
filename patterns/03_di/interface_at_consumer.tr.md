# Interface at Consumer (Tüketici Tarafında Interface)

## 1. Genel Bakış ve Tanım
Interface'lerin üretici yerine tüketen katmanda küçük ve amaca yönelik tanımlanması.
...
Gelen İstek / Görev
        |
        v
[ interface_at_consumer Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `interface_at_consumer.go`
- **Test Senaryoları**: `interface_at_consumer_test.go`
- **İngilizce Doküman**: `interface_at_consumer.md`
