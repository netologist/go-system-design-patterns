# Constructor Injection (Kurucu Fonksiyon Enjeksiyonu)

## 1. Genel Bakış ve Tanım
Bağımlılıkların kurucu fonksiyon üzerinden açık ve nil-güvenli şekilde aktarılması.
...
Gelen İstek / Görev
        |
        v
[ constructor_injection Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `constructor_injection.go`
- **Test Senaryoları**: `constructor_injection_test.go`
- **İngilizce Doküman**: `constructor_injection.md`
