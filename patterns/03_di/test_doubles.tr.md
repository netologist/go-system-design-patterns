# Test Doubles: Fakes, Stubs, Mocks, Spies (Test Çiftleri)

## 1. Genel Bakış ve Tanım
Gerçek altyapı yerine kullanılan bellek içi, sabit cevaplı ve çağrı kaydedici test çiftleri.
...
- **İmplementasyon**: `test_doubles.go`
- **Test Senaryoları**: `test_doubles_test.go`
- **İngilizce Doküman**: `test_doubles.md`
