# Functional Options Pattern (Fonksiyonel Opsiyonlar)

## 1. Genel Bakış ve Tanım
Çok sayıda opsiyonel ayar içeren struct'lar için genişletilebilir kurucu deseni.
...
Gelen İstek / Görev
        |
        v
[ functional_options Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `functional_options.go`
- **Test Senaryoları**: `functional_options_test.go`
- **İngilizce Doküman**: `functional_options.md`
