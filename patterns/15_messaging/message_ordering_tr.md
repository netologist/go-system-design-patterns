# Message Ordering & Partitioning (Mesaj Sıralaması)

## 1. Genel Bakış ve Tanım
Partition key hash'leme ile anahtar bazında kesin FIFO sıralama garantisi.
...
Gelen İstek / Görev
        |
        v
[ message_ordering Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `message_ordering.go`
- **Test Senaryoları**: `message_ordering_test.go`
- **İngilizce Doküman**: `message_ordering.md`
