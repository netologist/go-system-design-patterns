# Dead Letter Queue - DLQ (Ölü Mektup Kuyruğu)

## 1. Genel Bakış ve Tanım
Sürekli hata veren zehirli mesajları izole edip kuyruğu tıkamasını engelleme.
...
Gelen İstek / Görev
        |
        v
[ dead_letter_queue Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `dead_letter_queue.go`
- **Test Senaryoları**: `dead_letter_queue_test.go`
- **İngilizce Doküman**: `dead_letter_queue.md`
