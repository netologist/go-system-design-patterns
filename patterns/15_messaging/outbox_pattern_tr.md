# Transactional Outbox Pattern (İşlemsel Outbox)

## 1. Genel Bakış ve Tanım
Veritabanı güncellemesi ile olay fırlatmayı tek atomik transaction'da birleştirme.
...
Gelen İstek / Görev
        |
        v
[ outbox_pattern Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `outbox_pattern.go`
- **Test Senaryoları**: `outbox_pattern_test.go`
- **İngilizce Doküman**: `outbox_pattern.md`
