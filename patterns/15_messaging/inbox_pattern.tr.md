...
Gelen olayları veritabanında processed olarak kaydedip çift işlemeyi önleme.
...
- **İmplementasyon**: `inbox_pattern.go`
- **Test Senaryoları**: `inbox_pattern_test.go`
- **İngilizce Doküman**: `inbox_pattern.md`
