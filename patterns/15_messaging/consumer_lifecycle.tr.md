# Consumer Lifecycle & Graceful Drain (Tüketici Yaşam Döngüsü)

## 1. Genel Bakış ve Tanım
Kapanış sırasında çekilmiş aktif mesajları tamamlayıp kayıp vermeden durma.
...
Gelen İstek / Görev
        |
        v
[ consumer_lifecycle Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `consumer_lifecycle.go`
- **Test Senaryoları**: `consumer_lifecycle_test.go`
- **İngilizce Doküman**: `consumer_lifecycle.md`
