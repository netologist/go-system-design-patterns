# Idempotent Consumer (İdempotent Tüketici)

## 1. Genel Bakış ve Tanım
At-least-once mesajlaşmada aynı mesaj tekrar geldiğinde yan etki üretmeme.
...
Gelen İstek / Görev
        |
        v
[ idempotent_consumer Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `idempotent_consumer.go`
- **Test Senaryoları**: `idempotent_consumer_test.go`
- **İngilizce Doküman**: `idempotent_consumer.md`
