# PreStop Hook & Connection Draining (K8s PreStop Boşaltma)

## 1. Genel Bakış ve Tanım
Pod silinirken önce unready işaretleyip ingress güncellenene kadar bekleyip sonra kapanma.
...
Gelen İstek / Görev
        |
        v
[ prestop_draining Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `prestop_draining.go`
- **Test Senaryoları**: `prestop_draining_test.go`
- **İngilizce Doküman**: `prestop_draining.md`
