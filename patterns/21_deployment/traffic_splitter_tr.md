# Canary & Blue/Green Traffic Splitter (Trafik Bölücü)

## 1. Genel Bakış ve Tanım
Yüzdelik canary ağırlığı ve anlık Blue/Green geçişi sağlayan trafik yönlendirici.
...
Gelen İstek / Görev
        |
        v
[ traffic_splitter Kontrol Katmanı ]
        |
...
- **İmplementasyon**: `traffic_splitter.go`
- **Test Senaryoları**: `traffic_splitter_test.go`
- **İngilizce Doküman**: `traffic_splitter.md`
